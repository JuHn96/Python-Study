...
# Read data
x, labels = read_data(
    "./머신러닝, 딥러닝 기초다지기/머신러닝/라. 머신러닝 알고리즘 상세/2) SVM(Support Vector Machine)/실습코드/SVM_DATA/points_class_0.txt",
    "./머신러닝, 딥러닝 기초다지기/머신러닝/라. 머신러닝 알고리즘 상세/2) SVM(Support Vector Machine)/실습코드/SVM_DATA/points_class_1.txt"
)
